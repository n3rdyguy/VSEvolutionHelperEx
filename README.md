...
**Version 1.9.1** — Interactive evolution, arcana, grimoire, map, stage-select, and character-select tooltips for **Vampire Survivors** on Unity 6 / BepInEx IL2CPP.
...
```
Loading [VS Evolution Helper 1.9.1]
